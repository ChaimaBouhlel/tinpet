                ...
                <section>
                    ...
                    <form onSubmit={handleSubmit}>
                        <label htmlFor="username">
                            ...
                            <X size={24} color="red" className={validName || !user ? "hidden" : "invalid"} />
                        </label>
                        <input
                            type="text"
                            id="username"
                        ...
                        <label htmlFor="confirm_pwd">
                            Confirm Password:
                            <Check size={24} color="green" className={validMatch && matchPwd ? "valid" : "hidden"} />
                            <X size={24} color="red" className={validMatch || !matchPwd ? "hidden" : "invalid"} />
                        </label>
                        <input
                            type="password"
                            id="confirm_pwd"
